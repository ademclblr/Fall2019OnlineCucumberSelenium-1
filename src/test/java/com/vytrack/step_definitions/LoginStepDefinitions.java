...
// copy step from terminal after running and delete the comments and throw and only keep below parts

public class LoginStepDefinitions {//if you want to print here, you have to say DRYRUN=FALSE, in stepDef
    ...
    @When("user logs in as a store manager") // this step coming from new scenarios beacuse only this step is different others same as before we already have it
    ...
    @When("user navigates to {string} and {string}")   //ctrl +shift+f: choose the word and apply steps
