...
public class VehiclesPage extends AbstractPageBase {
    ...
    public void setLicencePlateInput(String licencePlate){
        wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("input[name='custom_entity_type[LicensePlate]']")));
    ...
    //verify after adding new car, general info
